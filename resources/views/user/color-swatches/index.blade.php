                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="text-center" id="selected-color" style="font-weight: bold; font-size: 20px;"></div>
                            <br>
                            <div class="color-box" style="height: 200px; width: 200px; margin: 0 auto;">
                            </div>
                            <br>
                            <a href="/color-swatches/cart" class="btn btn-primary" style="margin: 0 auto; display: flex; width: fit-content;">Add to cart</a>
                        </div>
                        ...
                        <div class="color-picker row">
                            @if (!empty($productAttributes))
                                @foreach ($productAttributes as $color)
                                    @if ($color->attributeData->cat_color == 'White')
                                        <div class="color-box col-lg-1 col-md-2 col-sm-3 col-4"
                                            data-parent-id="{{ $color->parent_id }}"
                                            data-product-id="{{ $color->product_id }}"
                                            style="background-color:rgb({{ $color->attributeData->r_attr }}, {{ $color->attributeData->g_attr }}, {{ $color->attributeData->b_attr }} );">
                            ...
                            @if (!empty($cat_off_whites))
                                @foreach ($cat_off_whites as $color)
                                    <div class="color-box col-lg-1 col-md-2 col-sm-3 col-4" data-toggle="modal"
                                        data-target="#color-modal" data-backdrop="static" data-keyboard="false"
                                        style="background-color:rgb({{ $color->r_attr }}, {{ $color->g_attr }}, {{ $color->b_attr }} );">
