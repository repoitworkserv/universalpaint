    ...
    <div class="col-lg-12">
        ...
        <div class="row">
                            ...
                            <div class="carousel-inner">
                                    ...
                                    @endphp
                                        <div class="item {{ $x == 0 ? 'active' : '' }}">
                                            ...
                                            <div class="bnnr-img-cntnr" style="background: url({!! asset('img/post/') !!}/{!! \App\Post::findOrFail($banner)->featured_image; !!});"></div>
                                        </div>
                                    @php
                                            $x++;
                                            };
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="box box-gold ">
                    <div class="box-header">
                        <h3 class="box-title">Latest and Hot Deals</h3>
                        <div class="pull-right">
                            <input type="hidden" name="deals-array-meta" value="{!! $Page->GetMetaData('hot_deals', 'product')['meta_value']; !!}" class="deals-array-meta">
                            <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#addHotDeals"><span class="fa fa-plus"></span> Add</button>
                        </div>
                    </div>
                    <div class="box-body">
                        <div id="hot-deals-carousel" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                @php 
                                    if($Page->GetMetaData('hot_deals', 'product')['meta_value']) {
                                        $x = 0;                           
                                        foreach(explode(',', $Page->GetMetaData('hot_deals', 'product')['meta_value']) as $product) {
                                @endphp
                                    <li data-target="#hot-deals-carousel" data-slide-to="{{$x}}" class="{{ $x == 0 ? 'active' : '' }}"></li>
                                @php
                                        $x++;
                                        };
                                    };
                            ...
                            <div class="carousel-inner">
                                    ...
                                    @endphp
                                        <div class="item {{ $x == 0 ? 'active' : '' }}">
                                            <div class="post-admin-btn">
                                                <a href="{{ url('admin/item-delete/'.\App\Product::findOrFail($product)->id).'/hotDeals' }}" id="alert{{\App\Product::findOrFail($product)->name}}" onclick="return confirm('Are You Sure to delete this entry?')" class="badge bg-red"><span class="fa fa-trash"></span> Delete</a>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-5">
                            ...
                            <a class="left carousel-control" href="#hot-deals-carousel" data-slide="prev">
                            <span class="fa fa-angle-left"></span>
                            </a>
                            <a class="right carousel-control" href="#hot-deals-carousel" data-slide="next">
                            <span class="fa fa-angle-right"></span>
                            </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="box box-gold ">
                    <div class="box-header">
                        <h3 class="box-title">Official Brands</h3>
                        <div class="pull-right">
                            <input type="hidden" name="deals-array-meta" value="{!! $Page->GetMetaData('official_brands', 'brand')['meta_value']; !!}" class="official-brand-array-meta">
                            <button type="button" class="btn btn-success btn-block" data-toggle="modal" data-target="#addOfficialBrands"><span class="fa fa-plus"></span> Add</button>
                        </div>
                    </div>
                    <div class="box-body">
                        <div id="official-brands-carousel" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                @php 
                                    if($Page->GetMetaData('official_brands', 'brand')['meta_value']) {
                                        $x = 0;                           
                                        foreach(explode(',', $Page->GetMetaData('official_brands', 'brand')['meta_value']) as $brand) {
                                @endphp
                                    <li data-target="#official-brands-carousel" data-slide-to="{{$x}}" class="{{ $x == 0 ? 'active' : '' }}"></li>
                                @php
                                        $x++;
                                        };
                                    };
                            ...
                            <div class="carousel-inner">
                                    ...
                                    @endphp
                                        <div class="item {{ $x == 0 ? 'active' : '' }}">
                                            <div class="post-admin-btn">
                                                <a href="{{ url('admin/item-delete/'.\App\Brand::findOrFail($brand)->id).'/officialBrands' }}" id="alert{{\App\Brand::findOrFail($brand)->name}}" onclick="return confirm('Are You Sure to delete this entry?')" class="badge bg-red"><span class="fa fa-trash"></span> Delete</a>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="dls-img-cntnr" style="background: url({!! asset('img/brand/') !!}/{!! \App\Brand::findOrFail($brand)->featured_img; !!});"></div>
                                                </div>
                                                <div class="col-lg-12 text-center">
                                                    <div class="sld-ttl">{!! \App\Brand::findOrFail($brand)->name; !!}</div>
                                                    <div class="sld-dsc">{!! \App\Brand::findOrFail($brand)->description; !!}</div>
                                                </div>
                                            </div>
                                        </div>
                                    @php
                            ...
                            <a class="left carousel-control" href="#official-brands-carousel" data-slide="prev">
                            <span class="fa fa-angle-left"></span>
                            </a>
                            <a class="right carousel-control" href="#official-brands-carousel" data-slide="next">
                            <span class="fa fa-angle-right"></span>
                            </a>
                        </div>
                    </div>
...
<div class="modal fade" id="addHotDeals" role="dialog" aria-labelledby="addHotDealsLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addHotDealsLabel">Add Latest and Hot Deals</h5>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" id="deals-product-list" multiple="multiple" name="deals-product-list[]">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-warning" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="add-hot-deals">ADD</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="addOfficialBrands" role="dialog" aria-labelledby="addOfficialBrandsLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addOfficialBrandsLabel">Add Official Brand</h5>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true" id="official-brand-list" multiple="multiple" name="official-brand-list[]">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-warning" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="add-official-brand">ADD</button>
            </div>
        </div>
    </div>
</div>
