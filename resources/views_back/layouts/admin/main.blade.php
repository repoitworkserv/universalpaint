...
<head>
  ...
  <title>@yield('title', 'EZ Deal | Admin')</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin/dashboard" class="logo" target="_blank">
      ...
      <span class="logo-mini"><b>G&G</b></span>
      <!-- logo for regular state and mobile devices -->
      <!-- <span class="logo-lg"><b>G&G</b> Admin</span> -->
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="#">G&G</a>.</strong> All rights reserved.
  </footer>
